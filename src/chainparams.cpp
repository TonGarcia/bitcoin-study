...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 10 * 30; // 5 minutes (before was 2 weeks (3.5 * 24 * 60 * 60))
        ...
        genesis = CreateGenesisBlock(1619182826, 0, 0x1d00ffff, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("localhost"); // localhost
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1619182824, 0, 0x1e0377ae, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1619182825, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
